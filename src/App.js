...
function App() {
  ...
  if (window.location.pathname === '/login') {
    return (
      ...
      <Routes>
        <Route path="/login" element={<Login authFlag={data.authFlag} jwt={data.jwt} doSignOut={doSignOut}/>} />
      </Routes>
      </div>
      </div>
      </Router>
    ...
    return (
      ...
      <Router>
      <div className='section'>
        <Header signOut={doSignOut} authFlag={true} userProfile={data.userProfile}/>
        {/* <Routes>
